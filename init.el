...
;; (cua-mode)  ;; disable cua-mode since ctrl-v conflicts with vim keybindings
...
(use-package emacs
  ...
  (set-face-attribute 'default nil      ; custom font, height 12px
...
;; keybindings (general.el configuration)
